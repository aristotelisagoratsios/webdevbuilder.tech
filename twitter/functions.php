<?php
   ...
   $link = mysqli_connect("shareddb-u.hosting.stackcp.net","twitter-31333374fd","7:pX^UZw1jJ`","twitter-31333374fd");
     ...
     date_default_timezone_set('Athens/Bucharest');
    ...
    return $print;
     ...
     function displaySearch() {
         ...
         echo ' <form class="col-auto">
                  <div class="mb-3">
                  <input type="hidden" name="page" value="search">
                  <input type="text" name="q" class="form-control" id="search" placeholder="Search">
                  </div>
                  <div class="mb-3">
                  <button type="submit" class="btn btn-primary mb-3">Search Tweets</button>
                  </div>               
               </form>';
     ...
     function displayTweetBox() {
        ...
        if ($_SESSION['id'] > 0) {
            ...
            echo '<div id="tweetSuccess" class="alert alert-success">Your tweet was posted successfully.</div>
                     ...
                     <div class="mb-3">
                     <textarea class="form-control" id="tweetContent" rows="5"></textarea>
                     </div>
                     <div class="mb-3">
                     <button  id="postTweetButton" class="btn btn-primary mb-3">Post Tweet</button>
                     </div>
                </div>';
